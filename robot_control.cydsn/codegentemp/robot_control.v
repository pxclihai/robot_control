...
// ADC_SAR_SEQ_v2_0(ADC_Clock_Frequency=1599840, Adjust=0, ClockSource=0, InputRange=1, NumChannels=9, Reference=0, Resolution=12, rm_int=false, SampleMode=0, SamplePrecharge=4, SampleRate=99990, SampleRate_def=631579, VrefValue=2.5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ADC_SAR_SEQ_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC, CY_INSTANCE_SHORT_NAME=ADC, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=ADC, )
module ADC_SAR_SEQ_v2_0_3 (
    ...
    bADC_SAR_SEQ_v2_0 bSAR_SEQ (
        ...
        .soc_out(soc_out),
        .sar_eoc(Net_3830));
    defparam bSAR_SEQ.NumChannels = 9;
...
module top ;
	...
	wire [0:0] tmpOE__PTZ_X_net;
	wire [0:0] tmpFB_0__PTZ_X_net;
	wire [0:0] tmpIO_0__PTZ_X_net;
	wire [0:0] tmpINTERRUPT_0__PTZ_X_net;
	electrical [0:0] tmpSIOVREF__PTZ_X_net;
	...
	cy_psoc3_pins_v1_10
		...
		PTZ_X
		 (.oe(tmpOE__PTZ_X_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PTZ_X_net[0:0]}),
		  .analog({Net_951}),
		  .io({tmpIO_0__PTZ_X_net[0:0]}),
		  .siovref(tmpSIOVREF__PTZ_X_net),
		  .interrupt({tmpINTERRUPT_0__PTZ_X_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PTZ_X_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__MSR_LOW_net;
	wire [0:0] tmpFB_0__MSR_LOW_net;
	wire [0:0] tmpIO_0__MSR_LOW_net;
	wire [0:0] tmpINTERRUPT_0__MSR_LOW_net;
	electrical [0:0] tmpSIOVREF__MSR_LOW_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("214a2d6e-e4c0-4768-a2df-227232d4aaca"),
		  ...
		  .input_buffer_sel(2'b00))
		MSR_LOW
		 (.oe(tmpOE__MSR_LOW_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MSR_LOW_net[0:0]}),
		  .io({tmpIO_0__MSR_LOW_net[0:0]}),
		  .siovref(tmpSIOVREF__MSR_LOW_net),
		  .interrupt({tmpINTERRUPT_0__MSR_LOW_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MSR_LOW_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__STR2_net;
	wire [0:0] tmpFB_0__STR2_net;
	wire [0:0] tmpIO_0__STR2_net;
	wire [0:0] tmpINTERRUPT_0__STR2_net;
	electrical [0:0] tmpSIOVREF__STR2_net;
	...
	cy_psoc3_pins_v1_10
		...
		STR2
		 (.oe(tmpOE__STR2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__STR2_net[0:0]}),
		  .io({tmpIO_0__STR2_net[0:0]}),
		  .siovref(tmpSIOVREF__STR2_net),
		  .interrupt({tmpINTERRUPT_0__STR2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__STR2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SWITCH_2_LOW_net;
	wire [0:0] tmpFB_0__SWITCH_2_LOW_net;
	wire [0:0] tmpIO_0__SWITCH_2_LOW_net;
	wire [0:0] tmpINTERRUPT_0__SWITCH_2_LOW_net;
	electrical [0:0] tmpSIOVREF__SWITCH_2_LOW_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("646698d5-ea04-4a83-a6ff-27a996b5aea4"),
		  ...
		  .input_buffer_sel(2'b00))
		SWITCH_2_LOW
		 (.oe(tmpOE__SWITCH_2_LOW_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SWITCH_2_LOW_net[0:0]}),
		  .io({tmpIO_0__SWITCH_2_LOW_net[0:0]}),
		  .siovref(tmpSIOVREF__SWITCH_2_LOW_net),
		  .interrupt({tmpINTERRUPT_0__SWITCH_2_LOW_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SWITCH_2_LOW_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SWITCH_1_LOW_net;
	wire [0:0] tmpFB_0__SWITCH_1_LOW_net;
	wire [0:0] tmpIO_0__SWITCH_1_LOW_net;
	wire [0:0] tmpINTERRUPT_0__SWITCH_1_LOW_net;
	electrical [0:0] tmpSIOVREF__SWITCH_1_LOW_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("b60442de-a407-4543-b353-bfb551d8c497"),
		  ...
		  .input_buffer_sel(2'b00))
		SWITCH_1_LOW
		 (.oe(tmpOE__SWITCH_1_LOW_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SWITCH_1_LOW_net[0:0]}),
		  .io({tmpIO_0__SWITCH_1_LOW_net[0:0]}),
		  .siovref(tmpSIOVREF__SWITCH_1_LOW_net),
		  .interrupt({tmpINTERRUPT_0__SWITCH_1_LOW_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SWITCH_1_LOW_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SWITCH_2_HIGH_net;
	wire [0:0] tmpFB_0__SWITCH_2_HIGH_net;
	wire [0:0] tmpIO_0__SWITCH_2_HIGH_net;
	wire [0:0] tmpINTERRUPT_0__SWITCH_2_HIGH_net;
	electrical [0:0] tmpSIOVREF__SWITCH_2_HIGH_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("9642834c-24d7-451a-9424-a401924434da"),
		  ...
		  .input_buffer_sel(2'b00))
		SWITCH_2_HIGH
		 (.oe(tmpOE__SWITCH_2_HIGH_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SWITCH_2_HIGH_net[0:0]}),
		  .io({tmpIO_0__SWITCH_2_HIGH_net[0:0]}),
		  .siovref(tmpSIOVREF__SWITCH_2_HIGH_net),
		  .interrupt({tmpINTERRUPT_0__SWITCH_2_HIGH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SWITCH_2_HIGH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__STR1_net;
	wire [0:0] tmpFB_0__STR1_net;
	wire [0:0] tmpIO_0__STR1_net;
	wire [0:0] tmpINTERRUPT_0__STR1_net;
	electrical [0:0] tmpSIOVREF__STR1_net;
	...
	cy_psoc3_pins_v1_10
		...
		STR1
		 (.oe(tmpOE__STR1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__STR1_net[0:0]}),
		  .io({tmpIO_0__STR1_net[0:0]}),
		  .siovref(tmpSIOVREF__STR1_net),
		  .interrupt({tmpINTERRUPT_0__STR1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__STR1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MSR_HIGH_net;
	wire [0:0] tmpFB_0__MSR_HIGH_net;
	wire [0:0] tmpIO_0__MSR_HIGH_net;
	wire [0:0] tmpINTERRUPT_0__MSR_HIGH_net;
	electrical [0:0] tmpSIOVREF__MSR_HIGH_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1cd49d33-ed65-4d0d-bff6-ae9a359e0743"),
		  ...
		  .input_buffer_sel(2'b00))
		MSR_HIGH
		 (.oe(tmpOE__MSR_HIGH_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MSR_HIGH_net[0:0]}),
		  .io({tmpIO_0__MSR_HIGH_net[0:0]}),
		  .siovref(tmpSIOVREF__MSR_HIGH_net),
		  .interrupt({tmpINTERRUPT_0__MSR_HIGH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MSR_HIGH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SWITCH_1_HIGH_net;
	wire [0:0] tmpFB_0__SWITCH_1_HIGH_net;
	wire [0:0] tmpIO_0__SWITCH_1_HIGH_net;
	wire [0:0] tmpINTERRUPT_0__SWITCH_1_HIGH_net;
	electrical [0:0] tmpSIOVREF__SWITCH_1_HIGH_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("f1b23ecd-ccbc-4ab6-8a27-e43638a52abb"),
		  ...
		  .input_buffer_sel(2'b00))
		SWITCH_1_HIGH
		 (.oe(tmpOE__SWITCH_1_HIGH_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SWITCH_1_HIGH_net[0:0]}),
		  .io({tmpIO_0__SWITCH_1_HIGH_net[0:0]}),
		  .siovref(tmpSIOVREF__SWITCH_1_HIGH_net),
		  .interrupt({tmpINTERRUPT_0__SWITCH_1_HIGH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SWITCH_1_HIGH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__PTZ_Y_net;
	wire [0:0] tmpFB_0__PTZ_Y_net;
	wire [0:0] tmpIO_0__PTZ_Y_net;
	wire [0:0] tmpINTERRUPT_0__PTZ_Y_net;
	electrical [0:0] tmpSIOVREF__PTZ_Y_net;
	...
	cy_psoc3_pins_v1_10
		...
		PTZ_Y
		 (.oe(tmpOE__PTZ_Y_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PTZ_Y_net[0:0]}),
		  .analog({Net_953}),
		  .io({tmpIO_0__PTZ_Y_net[0:0]}),
		  .siovref(tmpSIOVREF__PTZ_Y_net),
		  .interrupt({tmpINTERRUPT_0__PTZ_Y_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PTZ_Y_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CAR_Y_net;
	wire [0:0] tmpFB_0__CAR_Y_net;
	wire [0:0] tmpIO_0__CAR_Y_net;
	wire [0:0] tmpINTERRUPT_0__CAR_Y_net;
	electrical [0:0] tmpSIOVREF__CAR_Y_net;
	...
	cy_psoc3_pins_v1_10
		...
		CAR_Y
		 (.oe(tmpOE__CAR_Y_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CAR_Y_net[0:0]}),
		  .analog({Net_822}),
		  .io({tmpIO_0__CAR_Y_net[0:0]}),
		  .siovref(tmpSIOVREF__CAR_Y_net),
		  .interrupt({tmpINTERRUPT_0__CAR_Y_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CAR_Y_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__CAR_X_net;
	wire [0:0] tmpFB_0__CAR_X_net;
	wire [0:0] tmpIO_0__CAR_X_net;
	wire [0:0] tmpINTERRUPT_0__CAR_X_net;
	electrical [0:0] tmpSIOVREF__CAR_X_net;
	...
	cy_psoc3_pins_v1_10
		...
		CAR_X
		 (.oe(tmpOE__CAR_X_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CAR_X_net[0:0]}),
		  .analog({Net_820}),
		  .io({tmpIO_0__CAR_X_net[0:0]}),
		  .siovref(tmpSIOVREF__CAR_X_net),
		  .interrupt({tmpINTERRUPT_0__CAR_X_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CAR_X_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__CAR_SPEED_net;
	wire [0:0] tmpFB_0__CAR_SPEED_net;
	wire [0:0] tmpIO_0__CAR_SPEED_net;
	wire [0:0] tmpINTERRUPT_0__CAR_SPEED_net;
	electrical [0:0] tmpSIOVREF__CAR_SPEED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("6f7a7e11-e98d-4cf8-b823-e31200f06941"),
		  ...
		  .width(1))
		CAR_SPEED
		 (.oe(tmpOE__CAR_SPEED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CAR_SPEED_net[0:0]}),
		  .analog({Net_1834}),
		  .io({tmpIO_0__CAR_SPEED_net[0:0]}),
		  .siovref(tmpSIOVREF__CAR_SPEED_net),
		  .interrupt({tmpINTERRUPT_0__CAR_SPEED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CAR_SPEED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__WARNING_GREEN_net;
	wire [0:0] tmpFB_0__WARNING_GREEN_net;
	wire [0:0] tmpIO_0__WARNING_GREEN_net;
	wire [0:0] tmpINTERRUPT_0__WARNING_GREEN_net;
	electrical [0:0] tmpSIOVREF__WARNING_GREEN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		WARNING_GREEN
		 (.oe(tmpOE__WARNING_GREEN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__WARNING_GREEN_net[0:0]}),
		  .io({tmpIO_0__WARNING_GREEN_net[0:0]}),
		  .siovref(tmpSIOVREF__WARNING_GREEN_net),
		  .interrupt({tmpINTERRUPT_0__WARNING_GREEN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__WARNING_GREEN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__WARNING_BLUE_net;
	wire [0:0] tmpFB_0__WARNING_BLUE_net;
	wire [0:0] tmpIO_0__WARNING_BLUE_net;
	wire [0:0] tmpINTERRUPT_0__WARNING_BLUE_net;
	electrical [0:0] tmpSIOVREF__WARNING_BLUE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("afac048c-ed0d-4d3e-b2e1-70771911f6c7"),
		  ...
		  .input_buffer_sel(2'b00))
		WARNING_BLUE
		 (.oe(tmpOE__WARNING_BLUE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__WARNING_BLUE_net[0:0]}),
		  .io({tmpIO_0__WARNING_BLUE_net[0:0]}),
		  .siovref(tmpSIOVREF__WARNING_BLUE_net),
		  .interrupt({tmpINTERRUPT_0__WARNING_BLUE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__WARNING_BLUE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__WARNING_RED_net;
	wire [0:0] tmpFB_0__WARNING_RED_net;
	wire [0:0] tmpIO_0__WARNING_RED_net;
	wire [0:0] tmpINTERRUPT_0__WARNING_RED_net;
	electrical [0:0] tmpSIOVREF__WARNING_RED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("eaff91d0-f8dc-4233-b164-26bb37682e75"),
		  ...
		  .input_buffer_sel(2'b00))
		WARNING_RED
		 (.oe(tmpOE__WARNING_RED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__WARNING_RED_net[0:0]}),
		  .io({tmpIO_0__WARNING_RED_net[0:0]}),
		  .siovref(tmpSIOVREF__WARNING_RED_net),
		  .interrupt({tmpINTERRUPT_0__WARNING_RED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__WARNING_RED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
