...
*
*  PWM1_DM_STRONG     Strong Drive 
*  PWM1_DM_OD_HI      Open Drain, Drives High 
*  PWM1_DM_OD_LO      Open Drain, Drives Low 
*  PWM1_DM_RES_UP     Resistive Pull Up 
*  PWM1_DM_RES_DWN    Resistive Pull Down 
*  PWM1_DM_RES_UPDWN  Resistive Pull Up/Down 
*  PWM1_DM_DIG_HIZ    High Impedance Digital 
*  PWM1_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
*  
* Note:
*  Macro PWM1_ReadPS calls this function. 
*  
*******************************************************************************/
