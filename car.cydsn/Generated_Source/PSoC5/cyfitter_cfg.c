...
#define BS_UDB_1_1_0_CONFIG_VAL ((const uint8 CYFAR *)0x480007E0u)

/* IOPINS0_0 Address: CYREG_PRT0_DR Size (bytes): 10 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000860u)
...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x48000888u)
...
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x4800089Cu)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR0_SW0, 0x72u);
