...
*  This function is called by the UART_net_Sleep() function.
*
* Parameters:
*  None.
*
...
*
* Notes:
*  If this function is called without calling UART_net_SaveConfig() 
...
*  The UART_net_Sleep() API saves the current component state. Then it
*  calls the UART_net_Stop() function and calls 
*  UART_net_SaveConfig() to save the hardware configuration.
*  Call the UART_net_Sleep() function before calling the CyPmSleep() 
...
*  UART_net_Sleep() was called. The UART_net_Wakeup() function
*  calls the UART_net_RestoreConfig() function to restore the 
*  configuration. If the component was enabled before the 
*  UART_net_Sleep() function was called, the UART_net_Wakeup()
